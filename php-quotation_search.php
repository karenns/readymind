...
if($_SERVER['REQUEST_METHOD'] == "GET"){
	...
	//Search by DV or SP. Words 'development' and 'support' are not on the database	
	if ($searchValue == 'development'){
		$searchValue = 'DV';
	}
	if ($searchValue == 'support'){
		$searchValue = 'SP';
	}
	
	
	$quotation = new Quotation();
	$json_quotation = $quotation -> search_Quotation($searchValue);
